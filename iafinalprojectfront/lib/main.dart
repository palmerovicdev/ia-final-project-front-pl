...
import 'package:iafinalprojectfront/theme/presentation/bloc/theme_selector_cubit.dart';
import 'package:iafinalprojectfront/theme/theme.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context)=> serviceLocator.get<SelectionGameCubit>()),
      ],
